export const blogPosts = [
  {
    ...
    excerpt:
      'Discover how artificial intelligence is revolutionizing the way we edit and enhance images — and why human craft still leads.',
    image_url: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&q=80',
    created_at: '2025-07-15',
    author: 'Vista Editz Team',
    category: 'Photo Editing',
    content: `Artificial intelligence is transforming photo editing at an unprecedented pace. At Vista Edits, we integrate AI-assisted tools with human expertise to deliver faster turnaround without compromising quality.
...
The future belongs to editors who embrace technology while maintaining the artistic eye that machines cannot replicate. Vista Edits is at the forefront of this evolution, helping clients stay ahead in a visually driven marketplace.`,
  },
  {
    id: 2,
    title: 'Video Editing Trends That Define 2025',
    excerpt:
      'Stay ahead with the latest techniques and tools shaping professional video production this year.',
...
Color grading trends are moving toward natural, film-inspired looks rather than oversaturated styles. Our editors specialize in cinematic color science that enhances mood without looking artificial.
...
For real estate and corporate clients, 4K delivery with optimized web versions is now expected. Our video team ensures your content looks stunning on every screen — from mobile feeds to presentation displays.`,
  },
  {
    id: 3,
    title: 'Real Estate Photography Tips That Sell',
    excerpt:
    ...
    content: `Great real estate photography starts before the edit — but post-production is where good photos become great listings. Here are professional tips from the Vista Editz team.
...
After capture, professional editing makes the difference. HDR blending, vertical correction, sky enhancement, and twilight conversion can increase listing engagement by up to 40%. Our real estate editing packages are designed specifically for agents and photographers who need consistent, fast, high-quality results.`,
  },
];
